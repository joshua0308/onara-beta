...
function ProfileForm({ props }) {
  let { myPlayerData, playersRef, showTab } = props;
      ...
      >
        ...
        >
          ...
          >
            ...
            <li onClick={showNthTab(2)}>Location</li>
          ...
          <div id="box-container">
            ...
            <div className="tab tab-container">
              <div className="title-container">
                ...
                <p>
                  We will notify you when your friends send you a message
                  (opt-in)
                </p>
              </div>
              <div className="input-container">
